...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String prefLocationKey = context.getResources().getString(R.string.pref_location_key);
        String prefLocationDefault = context.getResources().getString(R.string.pref_location_default);

        return preferences.getString(prefLocationKey, prefLocationDefault);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String prefUnitsKey = context.getString(R.string.pref_units_key);
        String metricUnitsString = context.getString(R.string.pref_units_metric);

        String prefUnit = preferences.getString(prefUnitsKey, metricUnitsString);

        if(prefUnit.equals(metricUnitsString)) {
            return true;
        }
        return false;
    }
