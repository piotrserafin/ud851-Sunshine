...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFetchDataProgressBar = (ProgressBar) findViewById(R.id.pb_fetching_data);
    ...
    // COMPLETED (8) Create a method called showWeatherDataView that will hide the error message
    ...
    // COMPLETED (9) Create a method called showErrorMessage that will hide the weather data and
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        // COMPLETED (18) Within your AsyncTask, override the method onPreExecute and show the
        // loading indicator
        @Override
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                // COMPLETED (11) If the weather data was not null, make sure the data view is
                // visible
                showWeatherDataView();
                /*
