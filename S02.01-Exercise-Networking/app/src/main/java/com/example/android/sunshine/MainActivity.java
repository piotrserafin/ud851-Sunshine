...
//        }
    ...
    // COMPLETED (8) Create a method that will get the user's preferred location and execute your
    // new AsyncTask and call it loadWeatherData
    void loadWeatherData() {
        String prefferedLocation = SunshinePreferences.getPreferredWeatherLocation(MainActivity
                .this);
        new FetchWeatherTask().execute(prefferedLocation);
    }
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String queryResults = NetworkUtils.getResponseFromHttpUrl(queryUrl);

                String[] simpleFormatResult = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(MainActivity.this, queryResults);
