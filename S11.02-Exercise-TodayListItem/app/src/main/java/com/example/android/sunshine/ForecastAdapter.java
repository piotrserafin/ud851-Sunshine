...
//  COMPLETED (6) Declare constant IDs for the ViewType for today and for a future day
    private static final int VIEW_TYPE_TODAY = 1234;
    private static final int VIEW_TYPE_FUTURE_DAY = 5678;
...
//      COMPLETED (14) Otherwise, throw an IllegalArgumentException
            default:
                throw new IllegalArgumentException("Invalid viewType value: " + viewType);
        }
