...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (3) Add a PreferenceScreen with an EditTextPreference and ListPreference
        // within the newly created xml resource directory
        ...
        // COMPLETED (5) Override onCreatePreferences and add the preference xml file using
