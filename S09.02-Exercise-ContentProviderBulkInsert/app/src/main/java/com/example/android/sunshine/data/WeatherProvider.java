...
//          COMPLETED (2) Only perform our implementation of bulkInsert if the URI matches the
// CODE_WEATHER code
        ...
        switch (sUriMatcher.match(uri)) {
            case CODE_WEATHER: {
                ...
                // COMPLETED (3) Return the number of rows inserted from our implementation of
                // bulkInsert
                if (rowsInserted > 0) {
            ...
            // COMPLETED (4) If the URI does match match CODE_WEATHER, return the super
