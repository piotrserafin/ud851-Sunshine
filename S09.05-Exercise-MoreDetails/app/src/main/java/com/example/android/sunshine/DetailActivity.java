...
//  COMPLETED (20) Create a constant int to identify our loader used in DetailActivity
    private static final int ID_DETAIL_FORECAST_LOADER = 42;
    /*
...
//  COMPLETED (11) Declare TextViews for the date, description, high, low, humidity, wind, and pressure
    private TextView mWeatherDisplayDate;
    private TextView mWeatherDisplayDescription;
    private TextView mWeatherDisplayHighTemp;
    private TextView mWeatherDisplayLowTemp;
    private TextView mWeatherDisplayHumitidy;
    private TextView mWeatherDisplayWind;
    private TextView mWeatherDisplayPressure;
...
//      COMPLETED (13) Find each of the TextViews by ID
        mWeatherDisplayDate = findViewById(R.id.tv_weather_display_date);
        mWeatherDisplayDescription = findViewById(R.id.tv_weather_display_desription);
        mWeatherDisplayHighTemp = findViewById(R.id.tv_weather_display_high_temp);
        mWeatherDisplayLowTemp = findViewById(R.id.tv_weather_display_low_temp);
        mWeatherDisplayHumitidy = findViewById(R.id.tv_weather_display_humidity);
        mWeatherDisplayWind = findViewById(R.id.tv_weather_display_wind);
        mWeatherDisplayPressure = findViewById(R.id.tv_weather_display_pressure);
...
//      COMPLETED (17) Throw a NullPointerException if that URI is null
        if (null == mUri) throw new NullPointerException("NULL Uri");
...
//      COMPLETED (31) Display the wind speed and direction
        ...
        mWeatherDisplayWind.setText(windString);

//      COMPLETED (32) Display the pressure
        float pressure = data.getFloat(INDEX_WEATHER_PRESSURE);
        String pressureString = getString(R.string.format_pressure, pressure);

        mWeatherDisplayPressure.setText(pressureString);
